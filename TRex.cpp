...
void TRex::init(SDL_Renderer *Renz, SDL_Texture *Text,double TopSpeed,double SPd,  int IDa, int Sx, int Sy, bool isPlayer, int type)
{
    ID = IDa;
    IsPlayer = isPlayer;
...
void TRex::update(double Xoffset, double Yoffset)
{
