...
private:
    ...
    bool ENTERtru = false; //Enter
    bool ESCtru = false; //Esc
...
public:
    ...
    std::string Text_Of_Input = "";

    std::string Get_Typing_Text()
    {
        return Text_Of_Input;
    }
    void Set_Typing_Text(std::string a)
    {
        Text_Of_Input = a;
    }
    ...
    void Set_Typing_Mode(bool a)
    {
        Typing_Mode = a;
    }
    bool Get_Typing_Mode()
    {
        return Typing_Mode;
    }
    ...
    bool ENTERispressed();//Enter
    bool ESCispressed(); //Esc
