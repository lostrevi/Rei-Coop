...
void Player::init(SDL_Renderer *Renz, SDL_Texture *Text,double TopSpeed,double SPd,  int IDa, int Sx, int Sy, bool isPlayer, int type)
{
    ID = IDa;
    IsPlayer = isPlayer;
...
void Player::update(double Xoffset, double Yoffset)
{
    ...
    if(Attack && !AttackLOCK )
    {
        ...
        if(DIR == 1) //down
        {
            ...
            LOC.h = SpriteSize*2;
                ...
                DamageB.x = LOC.x + 27; //should work for up strike;
                DamageB.y = (LOC.y+54);
                DamageB.w = 10;
                DamageB.h = 35;
        ...
        else if(DIR == 0) //up
        {
            ...
            LOC.h = SpriteSize*2;
            LOC.y -= SpriteSize;
                DamageB.x = LOC.x + 25; //should work for up strike;
                DamageB.y = (LOC.y+40);
                DamageB.w = 10;
                DamageB.h = 35;
        ...
        else if(DIR == 2) //right
        {
            ...
            LOC.w = SpriteSize*2;
                ...
                DamageB.x = LOC.x + 52; //should work for up strike;
                DamageB.y = (LOC.y+28);
                DamageB.h = 10;
                DamageB.w = 35;
        ...
        else if(DIR == 3)//left
        {
            ...
            LOC.x -= SpriteSize;
                ...
                DamageB.x = LOC.x + 43; //should work for up strike;
                DamageB.y = (LOC.y+28);
                DamageB.h = 10;
                DamageB.w = 35;
